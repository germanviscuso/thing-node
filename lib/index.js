...
module.exports = {
  ...
  onboardWithVendorThingIdByUser(vendorThingId, thingPassword, user, thingType, thingProperties, callback) {
    ...
    const request = new _thingif.OnboardWithVendorThingIDRequest(vendorThingId, thingPassword, issuerId, thingType, thingProperties);
    apiAuthor.onboardWithVendorThingID(request, callback);
  },
  onboardWithThingIdByUser(thingId, thingPassword, user, thingType, thingProperties, callback) {
    const accessToken = user.getAccessToken();
    const apiAuthor = this.getThingIFApiAuthor(accessToken);
    const issuerId = new _thingif.TypedID(_thingif.Types.User, user.getID());
    const request = new _thingif.OnboardWithThingIDRequest(thingId, thingPassword, issuerId, thingType, thingProperties);
    apiAuthor.onboardWithThingID(request, callback);
  },
  onboardWithVendorThingIdByThing(vendorThingId, thingPassword, thingType, thingProperties, layoutPosition, accessToken, callback) {
  ...
  onboardWithThingIdByThing(thingId, thingPassword, thingType, thingProperties, layoutPosition, accessToken, callback) {
  ...
  onboardEndNodeWithVendorThingId(endNodeVendorThingId, endNodePassword, gatewayVendorThingId, endNodeThingProperties, endNodeThingType, owner, accessToken, callback) {
